...
export interface AppRendererHandle {
  ...
  /** Notify the Guest UI of host context changes */
  sendHostContextChange: (params: McpUiHostContextChangedNotification["params"]) => void;
}
...
export const AppRenderer = forwardRef<AppRendererHandle, AppRendererProps>((props, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    sendHostContextChange: (params) => appBridge?.sendHostContextChange(params),
  }), [appBridge]);
