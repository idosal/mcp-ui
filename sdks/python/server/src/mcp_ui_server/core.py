...
def create_ui_resource_contents(options: CreateUIResourceOptions) -> TextResourceContents | BlobResourceContents:
    """Create ResourceContents from UI resource options.
    
    This creates MCP-standard ResourceContents objects that can be used directly
    in tool results or with MCP resource handling.
    
    Args:
        options: Configuration for the interactive resource
        
    Returns:
        A ResourceContents instance (TextResourceContents or BlobResourceContents)
    ...
    # Create ResourceContents based on encoding type
    encoding = options.encoding
