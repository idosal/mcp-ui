...
When the MCP Apps adapter is enabled, the resource MIME type is automatically set to `text/html;profile=mcp-app`. This is the expected MIME type for MCP Apps-compliant hosts.
